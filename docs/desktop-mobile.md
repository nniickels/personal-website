...
| Shooting-star wishes | Click a visible star to pause it and display a wish message. | Tap the single occasional shooting star on Main Quest or Side Quests (24-second cycle); shooting stars are hidden in Playground. |
